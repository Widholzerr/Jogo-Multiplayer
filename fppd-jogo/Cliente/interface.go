...
const (
	...
	CorCinzaEscuro Cor = termbox.ColorDarkGray
	CorVermelho    Cor = termbox.ColorRed
	CorVerde       Cor = termbox.ColorGreen
	CorParede      Cor = termbox.ColorBlack | termbox.AttrBold | termbox.AttrDim
	CorFundoParede Cor = termbox.ColorDarkGray
...
func interfaceLerEventoTeclado() EventoTeclado {
	...
	case ev.Ch == 'w' || ev.Ch == 'a' || ev.Ch == 's' || ev.Ch == 'd':
